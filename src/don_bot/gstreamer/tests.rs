...
fn test_concat_clips(){
    ...
    let pipeline = stitch_videos(vec!["/home/mimerme/projects/donbot.rs/downloads/AT-cm585662124.mp4".to_string(),
                "/home/mimerme/Downloads/SampleVideo_1280x720_1mb.mp4".to_string()], &cfg);
